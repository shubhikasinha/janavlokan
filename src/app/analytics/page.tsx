...
export default function AnalyticsPage() {
  ...
  const [dynamicResults, setDynamicResults] = useState<Beneficiary[]>([]);
  ...
  useEffect(() => {
    const fetchDynamicData = async () => {
      ...
      try {
        const res = await fetch(`/api/beneficiaries/high-risk?limit=50&dynamic=true&threshold=${threshold}`);
        if (res.ok) {
          const data = await res.json();
  ...
  const dynamicCounts = {
    high: dynamicResults.filter(b => b.mean_squared_error > threshold * 2).length,
    medium: dynamicResults.filter(b => b.mean_squared_error > threshold && b.mean_squared_error <= threshold * 2).length,
    low: dynamicResults.filter(b => b.mean_squared_error <= threshold).length,
  };
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Geographic risk heatmaps • Risk distribution • Temporal spike detection • Interactive analysis
              </p>
            </div>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      State-wise risk concentration across India
                    </p>
                  </div>
                </div>
                <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
                  <IndiaMap title="National Risk Heatmap" height="400px" />
                </div>
              </div>
              ...
              <div className="mb-8">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Click markers for detailed anomaly information
                    </p>
                  </div>
                  {selectedDistrict && (
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-xl p-6 mb-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700 text-sm">MSE Threshold:</span>
                  ...
                  <div className="grid grid-cols-3 gap-3 text-center">
                    <div className="bg-red-100 border border-red-200 rounded-lg p-3">
                      ...
                      <div className="text-gray-500 text-[10px]">MSE &gt; {(threshold * 2).toFixed(1)}</div>
                    </div>
                    <div className="bg-amber-100 border border-amber-200 rounded-lg p-3">
                      ...
                      <div className="text-gray-500 text-[10px]">MSE &gt; {threshold.toFixed(1)}</div>
                    </div>
                  ...
                  <p className="text-xs text-gray-600 text-center">
                    🎯 Move the slider to adjust fraud detection sensitivity in real-time. 
                    Lower threshold = more sensitive (catches more potential fraud, but may have false positives)
                  </p>
                </div>
              </div>
            </>
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <ul className="space-y-1 text-gray-600">
                  ...
                  <li>• &quot;Policy-aware threshold calibration&quot; (via slider)</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-6 bg-gray-50 border-t border-gray-200">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <p className="text-gray-600 mb-4">
            Ready to investigate specific cases?
          </p>
